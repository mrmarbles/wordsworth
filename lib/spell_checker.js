...
SpellChecker.prototype.initialize = function(seedPath,
  ...
  //allows the seed and training paths to be omitted,
  // if this is the case, shift "seedPath" to "callback" and set the defaults.
  if(arguments.length === 1){
    callback = seedPath;
    seedPath = __dirname + "/../data/en_US/seed.txt";
    trainingDataPath = __dirname + "/../data/en_US/training.txt";
  }
